...
[🟢 **Start Here — Beginner Guide**](QUICKSTART.md) · [📖 Read the Specification](framework/SPERB-SPECIFICATION.md) · [🚀 Run Your Own Evaluation](#-how-to-evaluate-a-persona) · [📊 View the Pilot Results](pilot/PILOT_RESULTS.md) · [🤝 Contribute](CONTRIBUTING.md)
